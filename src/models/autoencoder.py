...
class ConvAutoencoder(nn.Module):
    def __init__(
        ...
        Args:
            encoder_channels (List[int]): list of channel sizes for the encoder, including the input channel size.
            decoder_channels (List[int]): list of channel sizes for the decoder, including the output channel size.
        """
        super().__init__()
