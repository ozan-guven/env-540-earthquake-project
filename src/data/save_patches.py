...
if __name__ == '__main__':
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=num_workers) as executor:
        ...
        futures = [executor.submit(_save_image_file_patches, post_image_file, MAXAR_POST_PATCHES_PATH) for post_image_file in post_image_files]
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=num_workers) as executor:
        ...
        futures = [executor.submit(_save_image_file_patches, pre_image_file, MAXAR_PRE_PATCHES_PATH) for pre_image_file in pre_image_files]
        for future in concurrent.futures.as_completed(futures):
            progress.update(1)
        progress.close()